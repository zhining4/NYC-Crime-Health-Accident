...
p1 <- ggplot(tmp2, aes( x = reorder(zip_code, count), y = count))+geom_bar( stat="identity",color = "blue", fill = "lightblue", binwidth = 1) + facet_wrap(~borough)+coord_flip()+xlab("zip_code")
...
p2 <- ggplot(tmp4, aes(  reorder(zip_code, count), y = count))+geom_bar( stat="identity",color = "blue", fill = "lightblue", binwidth = 1) + facet_wrap(~borough)+coord_flip()+xlab("zip_code")
...
p3 <- ggplot(tmp6, aes(  reorder(zip_code, count), y = count))+geom_bar( stat="identity",color = "blue", fill = "lightblue", binwidth = 1) + facet_wrap(~borough)+coord_flip()+xlab("zip_code")
...
p4 <- ggplot(tmp8, aes( reorder(zip_code, count), y = count))+geom_bar( stat="identity",color = "blue", fill = "lightblue", binwidth = 1) + facet_wrap(~borough)+coord_flip()+xlab("zip_code")
...
p5 <- ggplot(tmp10, aes( reorder(zip_code, count), y = count))+geom_bar( stat="identity",color = "blue", fill = "lightblue", binwidth = 1) + facet_wrap(~borough)+coord_flip()+xlab("zip_code")
